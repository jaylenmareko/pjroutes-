...
const BUYER_FAQS = [
  ...
  { q: 'What happens after I book?', a: 'Your booking is confirmed instantly. You\'ll receive an email with your receipt, FBO address (where to show up), and departure window. Expect a personal call from the operator 24–48 hrs before departure to confirm final details.' },
